...
<body>
                    ...
                    <div class="block-fluid">
                    	<form id="ztbForm" class="form-horizontal" name="ztbForm" action="<%=basePath %>/router/rest" target="_parent">
	                        ...
	                        <div class="row-form simple clearfix">
	                            ...
	                            <div class="span3"><input type="text" readonly="readonly"  id="cjsj"  name="cjsj" value="<%=new Date().toLocaleString() %>"></div>
	                        </div>
	                        <div class="row-form simple clearfix">
                            ...
                            <div class="row-form simple clearfix">
                                <div class="span2"><label class="control-label">文件摘要:</label></div>
                                <div class="span8">
                                    <textarea id="wjzy" name="wjzy"></textarea>
                                </div>
                            </div>
	                        <div class="row-form clearfix">
                                ...
                                <div class="span3">
                                     <div id="uploader">
                                         <!--用来存放文件信息-->
                                         <div id="thelist" class="uploader-list" style="width:300px;">
                                             <div class="item" id="WU_FILE_0">
                                                 <div class="info">
                                                     <span id="filename"></span>
                                                     <div style="float:right;">
                                                         <a id="downfile" class="remove-this btn btn-link" href="">下载</a>
                                                     </div>
                                                 </div>
                                             </div>
                                         </div>
	...
	<script type='text/javascript' src='<%=basePath %>/modules/demo/js/ztb.js'></script>
</body>
</html>
